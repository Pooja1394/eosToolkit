...
const FormObject = props => {
  ...
  const { values, touched, errors, handleChange, handleBlur, handleSubmit, onBlurText } = props;
...
const CreateAccountForm = props => {
  const { classes, handleSubmit, onBlurText, history } = props;
        ...
        <Card>
          ...
          <CardBody>
            <Formik
              ...
              render={formikProps => <FormObject {...formikProps} classes={classes} onBlurText={onBlurText} />}
            />
          </CardBody>
        </Card>
      </GridItem>
